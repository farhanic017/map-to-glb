...
export const paperspaceProvider: GPUProvider = {
  id: "paperspace",
  name: "Paperspace",
  description: "GPU cloud for ML and visualization. Good for sustained workloads.",
  type: "dedicated",
  requiresApiKey: true,
  requiresEndpoint: true,
  setupUrl: "https://www.paperspace.com/",
  estimatedCost: "medium",
  gpuTypes: ["M4000", "P5000", "P6000", "V100", "A100"],
  maxBuildings: 8000,
